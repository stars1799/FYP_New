              ...
              width="100%" height="800" frameborder="0"></iframe>')
                          ...
                          tabPanel(strong("Key Insight 2 & 3"),
                                   ...
                                   div(style = "background-color: #f2f2f2; padding: 10px; text-align: center;",
                                       ...
                                       div(style = "text-align: center;",
                                           HTML('<iframe id="tableauDashboard" src="https://public.tableau.com/views/PopulationDemographicAnalysis/Dashboard12?:embed=y&:showVizHome=no" width="100%" height="800" frameborder="0"></iframe>')
                                       )
                                   ),
                                   br(), 
                                   br(), 
